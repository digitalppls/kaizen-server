...
export type BonusPackageDocument = BonusPackage & Document;
export const BonusPackageSchema = SchemaFactory.createForClass(BonusPackage);


BonusPackageSchema.methods.toJSON = function () {
